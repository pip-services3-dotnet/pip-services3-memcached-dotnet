# Development and Testing Guide <br/> Pip.Services Memcached for .NET
...
```bash
nuget pack pip-services3-memcached-dotnet.nuspec
```

Publish the package on nuget global repository

```bash
nuget push PipServices3.Memcached.XXX.nupkg -Source https://www.nuget.org/api/v2/package
```
